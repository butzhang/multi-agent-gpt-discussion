...
├── multi_agent_gpt_discussion             # The main python package for the project
...
e.g: `cat multi_agent_gpt_discussion/VERSION` will get the project version without harming
